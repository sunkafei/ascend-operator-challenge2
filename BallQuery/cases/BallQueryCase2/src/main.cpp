...
OperatorDesc CreateOpDesc()
{
    ...
    int64_t m = 64;
    int64_t n = 32;
    std::vector<int64_t> shape_xyz {n, 3};
    std::vector<int64_t> shape_center_xyz {m, 3};
    std::vector<int64_t> shape_xyz_batch_cnt {2};
    std::vector<int64_t> shape_center_xyz_batch_cnt {2};
    ...
    opDesc.maxRadius= 50;
    opDesc.sampleNum = 13;
    std::vector<int64_t> shape_out {m, opDesc.sampleNum};
    ...
    opDesc.AddInputTensorDesc(outType, shape_xyz_batch_cnt.size(), shape_xyz_batch_cnt.data(), format);
    opDesc.AddInputTensorDesc(outType, shape_center_xyz_batch_cnt.size(), shape_center_xyz_batch_cnt.data(), format);
...
bool SetInputData(OpRunner &runner)
{
    ...
    ReadFile("../input/xyz_batch_cnt.bin", fileSize, runner.GetInputBuffer<void>(2), runner.GetInputSize(2));
    ReadFile("../input/center_xyz_batch_cnt.bin", fileSize, runner.GetInputBuffer<void>(3), runner.GetInputSize(3));
