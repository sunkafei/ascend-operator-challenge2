...
bool OpRunner::RunOp()
{
	...
	auto ret = aclnnGroupNormV2GetWorkspaceSize(inputTensor_[0], inputTensor_[1], inputTensor_[2], opDesc_->numGroups, 
                                                opDesc_->dataFormat, opDesc_->eps, opDesc_->isTraining,
    ...
    ret = aclnnGroupNormV2(workspace, workspaceSize, handle, stream);
