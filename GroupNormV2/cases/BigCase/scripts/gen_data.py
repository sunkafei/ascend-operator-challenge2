...
def gen_golden_data_simple(): # 26820
    input_x = np.random.uniform(-10, 10, [2, 4, 1024, 1024]).astype(np.float32)
    ...
    print("mean:", np.mean(input_x.reshape(2, -1), axis=1))
    print("std2:", np.std(input_x.reshape(2, -1), axis=1) ** 2)
